...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  default:  R(dest) = Mr(src1 + src2, 8); });//src1 = (Mr(src1 + src2, 8) & 0xffffffff00000000); if((src1 & 0x8000000000000000) == 0x8000000000000000) R(dest) = ((src1 >> 32) | 0xffffffff00000000) ; else R(dest) = (src1 >> 32); break;  });
