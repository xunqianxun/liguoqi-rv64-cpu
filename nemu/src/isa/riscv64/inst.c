...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw    , R, src1 = (src1 & 0x00000000ffffffff) - (src2 & 0x00000000ffffffff); if((src1 & 0x80000000) == 0x80000000) R(dest) = 0xffffffff00000000 | src1; else R(dest) = src1; );
