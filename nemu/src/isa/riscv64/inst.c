...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  default:    src1 = (Mr(src1 + src2, 8) & 0xffffffff00000000); if((src1 & 0x8000000000000000) == 1) R(dest) = ((src1 >> 32) | 0xffffffff00000000) ; else R(dest) = (src1 >> 32) | 0xffffffff00000000; break;  });
