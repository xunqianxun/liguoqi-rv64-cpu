...
void Vrvcpu___024root__traceInitSub0(Vrvcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declQuad(c+105,"rvcpu pip_pc", false,-1, 63,0);
        ...
        tracep->declBit(c+323,"rvcpu pip_fore0 clk", false,-1);
        ...
        tracep->declQuad(c+105,"rvcpu pip_fore0 pc_o", false,-1, 63,0);
        ...
        tracep->declQuad(c+360,"rvcpu pip_fore0 pc_next_data", false,-1, 63,0);
        tracep->declBit(c+323,"rvcpu pc1 clk", false,-1);
        tracep->declBit(c+324,"rvcpu pc1 rst", false,-1);
        tracep->declQuad(c+105,"rvcpu pc1 static_pc_i", false,-1, 63,0);
        ...
        tracep->declBit(c+362,"rvcpu id3 op1_loda_relate", false,-1);
        tracep->declBit(c+363,"rvcpu id3 op2_loda_relate", false,-1);
        ...
        tracep->declQuad(c+364,"rvcpu mem7 load_data", false,-1, 63,0);
        ...
        tracep->declQuad(c+366,"rvcpu mem7 sb_data", false,-1, 63,0);
        tracep->declQuad(c+368,"rvcpu mem7 sh_data", false,-1, 63,0);
        tracep->declQuad(c+370,"rvcpu mem7 sw_data", false,-1, 63,0);
        tracep->declBus(c+372,"rvcpu mem7 sb_mask", false,-1, 7,0);
        tracep->declBus(c+373,"rvcpu mem7 sh_mask", false,-1, 7,0);
        tracep->declBus(c+374,"rvcpu mem7 sw_mask", false,-1, 7,0);
...
void Vrvcpu___024root__traceFullSub0(Vrvcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullQData(oldp+105,(vlSelf->rvcpu__DOT__pip_pc),64);
        ...
        tracep->fullBit(oldp+363,(((IData)(vlSelf->rst)
                                    ? 0U : (1U & (((IData)(vlSelf->rvcpu__DOT__id_reg_ena2) 
                                                  ...
                                                  & ((IData)(vlSelf->rvcpu__DOT__id_reg_addr2) 
                                                     == (IData)(vlSelf->rvcpu__DOT__idex_ex_rdaddr)))))));
        tracep->fullQData(oldp+364,(((2U == (IData)(vlSelf->rvcpu__DOT__exmem_mem_type))
