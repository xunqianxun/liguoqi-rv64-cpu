...
VL_INLINE_OPT QData VysyxSoCFull___024root___change_request_1(VysyxSoCFull___024root* vlSelf) {
    ...
    VL_DEBUG_IF( if(__req && ((vlSelf->ysyxSoCFull__DOT__asic__DOT__lspi__DOT__mspi_spi_clk ^ vlSelf->__Vchglast__TOP__ysyxSoCFull__DOT__asic__DOT__lspi__DOT__mspi_spi_clk))) VL_DBG_MSGF("        CHANGE: vsrc/ysyxSoCFull.v:85096: ysyxSoCFull.asic.lspi.mspi_spi_clk\n"); );
