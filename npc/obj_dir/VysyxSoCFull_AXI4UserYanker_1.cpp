                                                         ...
                                                         ((3U 
                                                          ...
                                                          ((2U 
                                                           ...
                                                           ((1U 
                                                            ...
                                                            (~ (IData)(vlSelf->__PVT__QueueCompatibility__DOT__empty)))))))))))))))))) 
                              | (IData)(vlSymsp->TOP.reset)))))) {
        VL_WRITEF("[%0t] %%Error: ysyxSoCFull.v:42953: Assertion failed in %NysyxSoCFull.fpga.axi4yank\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("vsrc/ysyxSoCFull.v", 42953, "");
    }
                                                         ...
                                                         ((3U 
                                                          ...
                                                          ((2U 
                                                           ...
                                                           ((1U 
                                                            ...
                                                            (~ (IData)(vlSelf->__PVT__QueueCompatibility_16__DOT__empty)))))))))))))))))) 
                              | (IData)(vlSymsp->TOP.reset)))))) {
        VL_WRITEF("[%0t] %%Error: ysyxSoCFull.v:42977: Assertion failed in %NysyxSoCFull.fpga.axi4yank\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("vsrc/ysyxSoCFull.v", 42977, "");
    }
    if (vlSymsp->TOP.reset) {
        vlSelf->__PVT__QueueCompatibility__DOT__maybe_full = 0U;
