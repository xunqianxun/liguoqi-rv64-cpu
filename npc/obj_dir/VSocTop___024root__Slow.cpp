...
void VSocTop___024root___settle__TOP__1(VSocTop___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->SocTop__DOT__d_cache13__DOT__state_store 
            = vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt;
        if ((0x20U & (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store))) {
                        ...
                        if ((1U & (~ ((IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store) 
                            ...
                            if ((1U & (~ (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store)))) {
                                if (vlSelf->SocTop__DOT__arbitrate_d_ok) {
                                    vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 0x10U;
                                }
                                vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 0x20U;
                            }
                        }
                    }
                }
                    ...
                    if ((1U & (~ ((IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store) 
                        ...
                        if ((1U & (~ (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store)))) {
                            if (vlSelf->SocTop__DOT__d_cache13__DOT__write_ok) {
                                vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 1U;
                            }
                            vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 0x10U;
                        }
                    }
            ...
            if ((1U & (~ ((IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store) 
                ...
                if ((1U & (~ (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store)))) {
                    ...
                    vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 4U;
                }
            }
            ...
            if ((1U & (~ (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store)))) {
                ...
                vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 8U;
            }
        } else if ((1U & (IData)(vlSelf->SocTop__DOT__d_cache13__DOT__state_store))) {
            if (vlSelf->SocTop__DOT__rvcpu_we) {
                vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 2U;
            }
            vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = 1U;
        }
    }
                                                 ...
                                                 (((~ (IData)(vlSelf->SocTop__DOT__rvcpu1__DOT__id3__DOT__ex_op1)) 
                                                  ...
                                                  & (~ 
                                                     (((IData)(vlSelf->SocTop__DOT__rvcpu1__DOT__wb_id_addr) 
                                                       == (IData)(vlSelf->SocTop__DOT__rvcpu1__DOT__id_reg_addr1)) 
                                                      & (IData)(vlSelf->SocTop__DOT__rvcpu1__DOT__wb_id_ena))))))));
    if (vlSelf->SocTop__DOT__i_cache12__DOT__ord_data_ena) {
        vlSelf->out_axi_ar_id = 1U;
        vlSelf->out_axi_ar_addr = vlSelf->SocTop__DOT__rvcpu_data_addr;
    } else {
        vlSelf->out_axi_ar_id = ((IData)(vlSelf->SocTop__DOT__d_cache_read_ena)
                                  ? 2U : 0U);
        vlSelf->out_axi_ar_addr = ((IData)(vlSelf->SocTop__DOT__d_cache_read_ena)
                                    ? vlSelf->SocTop__DOT__rvcpu_inst_addr
                                    : 0ULL);
    }
...
void VSocTop___024root___ctor_var_reset(VSocTop___024root* vlSelf) {
    ...
    vlSelf->SocTop__DOT__d_cache_write_ena = VL_RAND_RESET_I(1);
    ...
    vlSelf->SocTop__DOT__i_cache12__DOT__i_in_data1 = VL_RAND_RESET_I(32);
    vlSelf->SocTop__DOT__i_cache12__DOT__i_in_data2 = VL_RAND_RESET_I(32);
    vlSelf->SocTop__DOT__i_cache12__DOT__i_data_ena2 = VL_RAND_RESET_I(1);
    ...
    vlSelf->SocTop__DOT__i_cache12__DOT__inst_hit_count1 = VL_RAND_RESET_I(3);
    vlSelf->SocTop__DOT__i_cache12__DOT__inst_hit_count2 = VL_RAND_RESET_I(3);
    vlSelf->SocTop__DOT__i_cache12__DOT__finish_the_mem_l = VL_RAND_RESET_I(1);
    ...
    vlSelf->SocTop__DOT__d_cache13__DOT__state_store_nxt = VL_RAND_RESET_I(6);
    ...
    vlSelf->SocTop__DOT__d_cache13__DOT__out_addr_wb = VL_RAND_RESET_Q(64);
    ...
    vlSelf->SocTop__DOT__arbitrate4__DOT__aw_shankhand = VL_RAND_RESET_I(1);
    vlSelf->SocTop__DOT__arbitrate4__DOT__w_shankhand = VL_RAND_RESET_I(1);
    ...
    vlSelf->SocTop__DOT__arbitrate4__DOT__r_shankhand = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vchglast__TOP__SocTop__DOT__d_cache13__DOT__state_store_nxt = VL_RAND_RESET_I(6);
    ...
    vlSelf->__Vchglast__TOP__SocTop__DOT__arbitrate4__DOT__cache_state = VL_RAND_RESET_I(2);
    vlSelf->__Vchglast__TOP__SocTop__DOT__arbitrate4__DOT__cache_state_nxt = VL_RAND_RESET_I(2);
