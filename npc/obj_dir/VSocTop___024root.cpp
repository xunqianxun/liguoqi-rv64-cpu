...
VL_INLINE_OPT void VSocTop___024root___combo__TOP__4(VSocTop___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSocTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSocTop___024root___combo__TOP__4\n"); );
    // Body
    if (vlSelf->rst) {
...
VL_INLINE_OPT void VSocTop___024root___combo__TOP__8(VSocTop___024root* vlSelf) {
    ...
    vlSelf->SocTop__DOT__t_axi_r_id = ((2U == (IData)(vlSelf->SocTop__DOT__axi_mnq4__DOT__s_read_state))
                                        ? ((IData)(vlSelf->SocTop__DOT__arbitrate4__DOT__i_cache_valid)
                                            ? 1U : 0U)
                                        : 0U);
    __Vtemp16 = ((IData)(vlSelf->rst) ? 1U : ((0x20U 
                                               & (IData)(vlSelf->SocTop__DOT__i_cache12__DOT__state_inst))
                                               ? 1U
                                               : ((0x10U 
                                                   & (IData)(vlSelf->SocTop__DOT__i_cache12__DOT__state_inst))
    ...
    __Vtableidx5 = (((2U == (IData)(vlSelf->SocTop__DOT__axi_mnq4__DOT__s_read_state)) 
                     << 4U) | (((IData)(vlSelf->SocTop__DOT__t_axi_ar_valid) 
                                << 3U) | ((((IData)(vlSelf->SocTop__DOT__t_axi_ar_ready) 
...
void VSocTop___024root___eval(VSocTop___024root* vlSelf) {
    ...
    VSocTop___024root___combo__TOP__4(vlSelf);
...
VL_INLINE_OPT QData VSocTop___024root___change_request_1(VSocTop___024root* vlSelf) {
    ...
    __req |= ((vlSelf->SocTop__DOT__i_cache12__DOT__state_inst ^ vlSelf->__Vchglast__TOP__SocTop__DOT__i_cache12__DOT__state_inst)
         | (vlSelf->SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt ^ vlSelf->__Vchglast__TOP__SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt));
    ...
    VL_DEBUG_IF( if(__req && ((vlSelf->SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt ^ vlSelf->__Vchglast__TOP__SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt))) VL_DBG_MSGF("        CHANGE: vsrc/axi_mnq.v:76: SocTop.axi_mnq4.s_write_state_nxt\n"); );
    // Final
    vlSelf->__Vchglast__TOP__SocTop__DOT__i_cache12__DOT__state_inst 
        = vlSelf->SocTop__DOT__i_cache12__DOT__state_inst;
    vlSelf->__Vchglast__TOP__SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt 
        = vlSelf->SocTop__DOT__axi_mnq4__DOT__s_write_state_nxt;
    return __req;
}
