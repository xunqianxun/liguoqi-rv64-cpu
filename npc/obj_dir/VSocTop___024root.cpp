...
VL_INLINE_OPT void VSocTop___024root___sequent__TOP__3(VSocTop___024root* vlSelf) {
    ...
    __Vdly__SocTop__DOT__arbitratem4__DOT__dwrite_ok 
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->SocTop__DOT__io_slave_axi9__DOT__write_data_reg 
            = ((IData)(vlSelf->SocTop__DOT__io_slave_axi9__DOT__aw_shankhand)
    ...
    if (vlSelf->SocTop__DOT__arbitratem4__DOT__dwrite_success) {
        ...
        __Vdly__SocTop__DOT__arbitratem4__DOT__dwrite_ok = 1U;
    } else if (vlSelf->SocTop__DOT__arbitratem4__DOT__dwrite_ok) {
        __Vdly__SocTop__DOT__arbitratem4__DOT__dwrite_ok = 0U;
