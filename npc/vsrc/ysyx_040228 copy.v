...
`define ysyx22040228_VGA_START     64'h0000000010002000
`define ysyx22040228_VGA_END       64'h0000000010001fff
`define ysyx22040228_PST_START     64'h0000000010003000
`define ysyx22040228_PST_END       64'h0000000010003fff
...
module ysyx_22040228arbitratem (
    ...
    assign success_dwrite       = ((arbitrate_state == `ysyx22040228_ARB_DWRITE)  && ((axi_b_resp == 2'b11 ) | (axi_b_resp == 2'b01) | (axi_b_resp == 2'b10) | (axi_b_resp == 2'b00)) && (axi_b_valid == `ysyx22040228_ABLE));
    ...
    assign success_uncahcewrite = ((arbitrate_state == `ysyx22040228_ARB_DWRITEU) && ((axi_b_resp == 2'b11 ) | (axi_b_resp == 2'b01) | (axi_b_resp == 2'b10) | (axi_b_resp == 2'b00)) && (axi_b_valid == `ysyx22040228_ABLE));
        ...
        case (counter)
            ...
            default:  begin
                ...
                if(temp_a[127:63] >= temp_b) begin 
                    temp_a <= ({{(temp_a[127:63] - temp_b), temp_a[62:0]}[126:0], 1'b0 }) ;
...
module ysyx_22040228pc ( 
    ...
    input    wire    [1:0]                                  stall_ctrl   ,   //pc暂停信号
    //to if
...
module ysyx_22040228uncache_mmio (
    ...
    assign uncache    = ((core_addr >= `ysyx22040228_UART_START) && (core_addr <= `ysyx22040228_UART_END)) |
                        ...
                        ((core_addr >= `ysyx22040228_VGA_START) && (core_addr <= `ysyx22040228_VGA_END)) |
                        ((core_addr >= `ysyx22040228_PST_START) && (core_addr <= `ysyx22040228_PST_END)) |
