...
module time_axi (
    ...
    assign csr_mtime_l_nxt   = csr_mtime_l_w_ena ? (wmask & time_axi_w_data) : (car_mtime_l + 1);
    assign csr_mtime_h_nxt   = csr_mtime_h_w_ena ? (wmask & time_axi_w_data) : csr_mtime_h      ;
